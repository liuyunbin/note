...
string to_bit(string bit) {
    ...
    string e_int_string = to_string(e_int);
    e_int_string = string(5 - (int)e_int_string.size(), ' ') + e_int_string;
...
string to_double_hand(string bit) {
    ...
    bitset<52> f_bit(f_str);  // 只用于判断 0 无穷 非数字
