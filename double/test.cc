...
void test15(const string& bit) {
    const string str = to_double_hand(bit);
    stringstream tmp(str);

    double x;
    tmp >> x;

    //cout << to_double_hand(bit) << " -> " << to_double_cs(x) << endl;
    cout << "  手动计算: "  << str << endl;
    cout << "计算机存储: "  << to_double_cs(x) << endl;
}

void test15() {
    test15("0 10000110011 0000 00000000 00000000 00000000 00000000 00000000 00000000");
    test15("0 10000110011 0000 00000000 00000000 00000000 00000000 00000000 00000000 00");
    test15("0 10000110011 0000 00000000 00000000 00000000 00000000 00000000 00000000 01");
    test15("0 10000110011 0000 00000000 00000000 00000000 00000000 00000000 00000000 10");
    test15("0 10000110011 0000 00000000 00000000 00000000 00000000 00000000 00000000 11");
    test15("0 10000110011 0000 00000000 00000000 00000000 00000000 00000000 00000001 00");

    cout << endl;
    test15("0 01111111011 1001 10011001 10011001 10011001 10011001 10011001 10011001 ");
    test15("0 01111111011 1001 10011001 10011001 10011001 10011001 10011001 10011010 ");
    test15("0 01111111011 1001 10011001 10011001 10011001 10011001 10011001 10011011 ");
}
