...
void output_help() {
  ...
  printf("\n");
  printf("例子：\n");
  printf("\t sudoku             从标准输入输入数据\n");
  printf("\t sudoku -a          从标准输入输入数据，输出所有解\n");
  printf("\t sudoku data.txt    从文件输入数据\n");
  printf("\t sudoku data.txt -a 从文件输入数据，输出所有解\n");
  printf("\t sudoku -h          输出帮助\n");
  printf("\n");
}
