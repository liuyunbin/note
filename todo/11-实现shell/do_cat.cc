...
static bool number          = false;  // 行号包括空行
static bool number_nonblank = false;  // 行号不包括空行
static bool squeeze_blank   = false;  // 折叠空行
static bool handle_tab      = false;  // TAB 转换
...
static void handle_cat(FILE* fp) {
    int  line           = 0;
