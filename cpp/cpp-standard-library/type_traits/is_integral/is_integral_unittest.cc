...
TEST(test_type_traits, test_is_integral) {
  EXPECT_EQ(std::is_integral<void>::value, liuyunbin::is_integral<void>::value);
  ...
  EXPECT_EQ(std::is_integral<char>::value, liuyunbin::is_integral<char>::value);
  ...
  EXPECT_EQ(std::is_integral<long>::value, liuyunbin::is_integral<long>::value);
