...
int main() {
    ...
    std::cout << "long: " << std::is_same<long, std::time_t>::value
              << std::endl;
    std::cout << "long long: " << std::is_same<long long, std::time_t>::value
              << std::endl;
    std::cout << "unsigned long: "
              << std::is_same<unsigned long, std::time_t>::value << std::endl;
    std::cout << "unsigned long long: "
              << std::is_same<unsigned long long, std::time_t>::value
              << std::endl;
