...
void backtrack(int* nums, int left, int right, int* left_max, int* right_max,
               int* current_max, int* sum) {
    if (left == right) {
    ...
    backtrack(nums, left, mid, &left_left_max, &left_right_max,
              &left_current_max, &left_sum);
    int right_left_max, right_right_max, right_current_max, right_sum;
    backtrack(nums, mid + 1, right, &right_left_max, &right_right_max,
              &right_current_max, &right_sum);
    *current_max = max(max(left_current_max, right_current_max),
                       left_right_max + right_left_max);
