...
0000000000401062 <phase_5>:
  ...
  40107f:	83 f8 06             	cmp    $0x6,%eax // 6 个字节
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx // cx 存储第一个字节
  40108f:	88 0c 24             	mov    %cl,(%rsp)
  401092:	48 8b 14 24          	mov    (%rsp),%rdx
  401096:	83 e2 0f             	and    $0xf,%edx // 去掉 dx 除最低 4 位外的所有位
  // rdx == "maduiersnfotvbylSo you think you can stop the bomb with ctrl-c, do you?"
  // rdx == "maduiersnf o  t  v  b  y  l  So you think you can stop the bomb with ctrl-c, do you?"
  ...
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp) // 添加 '\0' 到 rsp + 16 + 6 = rsp + 24
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi // "flyers"
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi // rsp + 16
...
00000000004010f4 <phase_6>:
  ...
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax // ax 存储 r13 所指向的数
  40111b:	83 e8 01             	sub    $0x1,%eax // ax -= 1
  40111e:	83 f8 05             	cmp    $0x5,%eax // ax <= 5, 每个数 <= 6
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>

  401128:	41 83 c4 01          	add    $0x1,%r12d // r12 += 1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d  // r12 != 6
  401130:	74 21                	je     401153 <phase_6+0x5f>
  401132:	44 89 e3             	mov    %r12d,%ebx // bx == r12

  401135:	48 63 c3             	movslq %ebx,%rax
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax // ax 存储下一个数
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp) // *ax != *rbp
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx // ++bx
  401148:	83 fb 05             	cmp    $0x5,%ebx // bx <= 5
  ...
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi // rsp + 16 + 8 = rsp + 24
  ...
  401164:	89 10                	mov    %edx,(%rax) // *ax = 7 - *ax
  ...
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx // 下一个节点
  ...
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) // *(rsp + 2 * rsi + 0x20) = dx 
  40118d:	48 83 c6 04          	add    $0x4,%rsi // rsi + 4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi  // rsi 24
  401195:	74 14                	je     4011ab <phase_6+0xb7>

  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx // cx = *(rsp + rsi) 读取输入的数
  40119a:	83 f9 01             	cmp    $0x1,%ecx // cx <= 1
  ...
  // 2 --> rsp + 2 * 4 * 2 + 0x20 = rsp + 16 + 0x20 = rsp + 0x30
  ...
  4011bd:	48 8b 10             	mov    (%rax),%rdx // dx = *ax
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) // 
  4011c4:	48 83 c0 08          	add    $0x8,%rax // 下一个元素
  ...
  4011e5:	39 03                	cmp    %eax,(%rbx) // 上一个结点必须大于等于下一结点
