...
TEST(test_type_traits, test_is_convertible) {
  ...
  EXPECT_EQ(liuyunbin_is_convertible_A_A::value, std_is_convertible_A_A::value);

  EXPECT_EQ(liuyunbin_is_convertible_A_B::value, std_is_convertible_A_B::value);
  EXPECT_EQ(liuyunbin_is_convertible_B_A::value, std_is_convertible_B_A::value);

  EXPECT_EQ(liuyunbin_is_convertible_A_C::value, std_is_convertible_A_C::value);
  EXPECT_EQ(liuyunbin_is_convertible_C_A::value, std_is_convertible_C_A::value);

  EXPECT_EQ(liuyunbin_is_convertible_A_D::value, std_is_convertible_A_D::value);
  EXPECT_EQ(liuyunbin_is_convertible_D_A::value, std_is_convertible_D_A::value);

  EXPECT_EQ(liuyunbin_is_convertible_B_D::value, std_is_convertible_B_D::value);
  EXPECT_EQ(liuyunbin_is_convertible_D_B::value, std_is_convertible_D_B::value);
}
