...
int main()
{
	...
	while (true)
	{
		...
		switch (choose)
		{
		case 1: sort.choose_sort(); break;
		case 2: sort.bubble_sort(); break;
		case 3: sort.double_bubble_sort(); break;
		case 4: sort.straight_insert_sort(); break;
		case 5: sort.insert_sort(); break;
		case 6: sort.insert_sort_digui(); break;
		case 7: sort.merge_sort(); break;
		case 8: sort.merge_insert_sort(); break;
		case 9: sort.quick_sort(); break;
		default: cout << " ‰»Î¥ÌŒÛ" << endl; break;
		}
		system("pause");
		system("cls");
	}
